...
if TYPE_CHECKING:
    ...
    from saag.simulation.models import SimulationReport, EventResult, FailureResult
    from saag.validation.models import PipelineResult, LayerValidationResult, ValidationTargets
