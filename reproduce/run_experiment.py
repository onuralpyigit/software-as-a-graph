...
-----
    ...
    python reproduce/run_experiment.py \
...
scenario_05,scenario_06,scenario_07,scenario_08,scenario_10 \
    ...
    python reproduce/run_experiment.py ... --skip-existing
...
# Ensure repo root is importable when invoked as `python reproduce/...`
...
def write_table_dataset_summary(reports: List[AblationReport], out_path: Path) -> None:
    ...
    lines = [
        r"% Auto-generated by reproduce/run_experiment.py",
        r"\begin{table}[t]",
        r"  \centering",
