...
def mock_quality_result():
    ...
    comp_a = ComponentQuality(
        id="A",
        type="Application",
        scores=QualityScores(overall=0.8, reliability=0.8, maintainability=0.8, availability=0.8),
        levels=QualityLevels(overall=CriticalityLevel.HIGH, reliability=CriticalityLevel.HIGH, maintainability=CriticalityLevel.HIGH, availability=CriticalityLevel.HIGH),
    ...
    comp_b = ComponentQuality(
        id="B",
        type="Application",
        scores=QualityScores(overall=0.4, reliability=0.4, maintainability=0.4, availability=0.4),
        levels=QualityLevels(overall=CriticalityLevel.MEDIUM, reliability=CriticalityLevel.MEDIUM, maintainability=CriticalityLevel.MEDIUM, availability=CriticalityLevel.MEDIUM),
