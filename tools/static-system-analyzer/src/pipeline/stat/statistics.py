...
def compute_topic_bandwidth_stats(cc: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return {
        "sizes": sizes, "subs": subs, "labels": labels,
...
def compute_app_balance_stats(cc: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return {
        "pubs": pubs, "subs": subs, "labels": labels,
        "io_load": io_load,
        "outlier_indices": outlier_indices,
...
def compute_node_comm_load_stats(cc: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return {
        "node_ids": node_ids, "sorted_labels": sorted_labels,
...
def compute_criticality_io_stats(cc: Dict[str, Any]) -> Dict[str, Any]:
    ...
    crit_pubs, crit_subs, crit_labels = [], [], []
    norm_pubs, norm_subs, norm_labels = [], [], []
    ...
    return {
        "crit_pubs": crit_pubs, "crit_subs": crit_subs, "crit_labels": crit_labels,
        "norm_pubs": norm_pubs, "norm_subs": norm_subs, "norm_labels": norm_labels,
        "crit_io": crit_io,
