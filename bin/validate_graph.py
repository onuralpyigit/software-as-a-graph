...
python bin/validate_graph.py single --input input/system.json

# Single run — QoS-enriched
python bin/validate_graph.py single --input input/system.json --qos

# Multi-seed stability sweep
python bin/validate_graph.py sweep --input input/system.json --qos

# Full report (sweep + topology-class gates + node-type strata)
python bin/validate_graph.py report --input input/system.json \\
...
# Add project root and backend/src to PYTHONPATH
