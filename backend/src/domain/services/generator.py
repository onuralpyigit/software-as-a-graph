"""
Graph Generator Domain Service

Service for generating graph structures.
"""
...
from src.domain.models.entities import (
    ...
    Topic,
    Library,
    # QoSPolicy is used for topic creation
)
from src.domain.models import QoSPolicy
...
class StatisticalGraphGenerator:
    ...
    def _make_edge(self, src: Any, tgt: Any) -> Dict[str, str]:
        # Helper to create edge structure matching existing expectations
        # Expected format from entities is {"from": id, "to": id}
        # But here we are returning raw dicts to matching legacy or service needs?
        # The service calls this generate() and returns a dict.
        # The input entities are domain objects with .id
    ...
    def generate(self) -> Dict[str, Any]:
        ...
        # 1. Generate base entities using Domain Models
