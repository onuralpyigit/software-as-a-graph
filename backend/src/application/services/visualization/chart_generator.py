...
# ─── Color Constants (§6.6 Visual Encoding Specification) ────────────────
...
RMAV_COLORS = {
    "reliability": "#3498DB",      # Blue
    "maintainability": "#2ECC71",  # Green
    "availability": "#E67E22",     # Orange
    "vulnerability": "#9B59B6",    # Purple
}
