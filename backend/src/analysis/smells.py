"""
backend/src/analysis/smells.py — Pub-Sub Architectural Anti-Pattern & Bad Smell Engine
"""
...
logger = logging.getLogger("smell_engine")
...
class SmellDetector:
    ...
    def _detect_unstable_interface(self, lr, layer: str, stats: Dict) -> List[DetectedSmell]:
        ...
        smells = []
        for c in lr.quality.components:
            coupling = c.scores.maintainability
            if coupling > 0.80:
                smells.append(self._make_smell(
