...
# =============================================================================
# CLI (bin/benchmark.py)
# =============================================================================

class TestBenchmarkCLI:
    """Tests for the bin/benchmark.py entry point."""

    def _run_main(self, argv: list[str]) -> int:
        """Reload benchmark module and call main() with mocked BenchmarkRunner."""
    ...
    def test_scales_flag(self, mock_close, mock_run, tmp_output):
        """--scales should create one scenario per scale."""
    ...
    def test_full_suite_flag(self, mock_close, mock_run, tmp_output):
        """--full-suite should create scenarios for tiny, small, medium."""
        mock_run.return_value = []
    ...
    def test_default_scenario(self, mock_close, mock_run, tmp_output):
        """No mode flag → default medium scenario."""
        mock_run.return_value = []
    ...
    def test_layers_forwarded(self, mock_close, mock_run, tmp_output):
        """--layers should be forwarded to scenarios."""
        mock_run.return_value = []
    ...
    def test_runs_forwarded(self, mock_close, mock_run, tmp_output):
        """--runs should set runs on scenarios."""
        mock_run.return_value = []
    ...
    def test_reports_generated(self, mock_close, mock_run, tmp_output):
        """Reports should be written to the output directory."""
        mock_run.return_value = []
