...
def test_coupling_risk_capping():
    ...
    from src.analysis.models import LayerAnalysisResult, StructuralAnalysisResult, GraphSummary
...
def test_coupling_risk_modulation():
    ...
    from src.analysis.models import StructuralAnalysisResult, GraphSummary
    from src.core.layers import AnalysisLayer
