...
if TYPE_CHECKING:
    ...
    from saag.explanation.engine import SystemReport

from saag.core.layers import AnalysisLayer
from saag.core.metrics import StructuralMetrics, EdgeMetrics, GraphSummary, QualityScores, QualityLevels, ComponentQuality, EdgeQuality
...
class LayerAnalysisResult:
    ...
    def graph_summary(self) -> GraphSummary:
        """Proxy to the graph summary stored in structural results."""
        return self.structural.graph_summary
