...
class RealWorldAdapter:
    ...
    def create_homeassistant_topology() -> Dict[str, Any]:
        ...
        topics = [
            ...
            {"id": "T1", "name": "event.call_service", "size": 256, "qos": {"durability": "VOLATILE", "reliability": "RELIABLE", "transport_priority": "CRITICAL"}, "frequency": 50.0, "criticality": "critical"},
            {"id": "T2", "name": "alarm.hazard.fire_smoke", "size": 128, "qos": {"durability": "TRANSIENT_LOCAL", "reliability": "RELIABLE", "transport_priority": "HIGHEST"}, "frequency": 1.0, "criticality": "critical"},
            {"id": "T3", "name": "alarm.hazard.water_leak", "size": 128, "qos": {"durability": "TRANSIENT_LOCAL", "reliability": "RELIABLE", "transport_priority": "HIGHEST"}, "frequency": 1.0, "criticality": "critical"},
            {"id": "T4", "name": "alarm.security.intrusion", "size": 256, "qos": {"durability": "TRANSIENT_LOCAL", "reliability": "RELIABLE", "transport_priority": "HIGHEST"}, "frequency": 2.0, "criticality": "critical"},
            ...
            {"id": "T8", "name": "command.actuate.valve", "size": 128, "qos": {"durability": "PERSISTENT", "reliability": "RELIABLE", "transport_priority": "HIGHEST"}, "frequency": 0.5, "criticality": "critical"},
            {"id": "T9", "name": "command.actuate.siren", "size": 128, "qos": {"durability": "TRANSIENT_LOCAL", "reliability": "RELIABLE", "transport_priority": "HIGHEST"}, "frequency": 1.0, "criticality": "critical"},
        ...
        applications = [
            # Core & Automation
            {"id": "A0", "name": "core_state_machine", "app_type": "sensor", "criticality": True, "priority": "HIGHEST", "code_metrics": {"size": {"total_loc": 5800, "total_classes": 26, "total_methods": 175}, "complexity": {"avg_wmc": 24.5}, "cohesion": {"avg_lcom": 22.0}, "coupling": {"avg_cbo": 12.0, "avg_rfc": 39.5}}},
            {"id": "A1", "name": "automation_engine", "app_type": "processor", "criticality": True, "priority": "HIGHEST", "code_metrics": {"size": {"total_loc": 6400, "total_classes": 30, "total_methods": 190}, "complexity": {"avg_wmc": 28.0}, "cohesion": {"avg_lcom": 26.5}, "coupling": {"avg_cbo": 14.2, "avg_rfc": 45.0}}},
            {"id": "A2", "name": "script_execution_service", "app_type": "processor", "criticality": True, "priority": "HIGH", "code_metrics": {"size": {"total_loc": 3200, "total_classes": 15, "total_methods": 95}, "complexity": {"avg_wmc": 16.0}, "cohesion": {"avg_lcom": 14.2}, "coupling": {"avg_cbo": 8.1, "avg_rfc": 25.4}}},
            {"id": "A3", "name": "safety_hazard_monitor", "app_type": "processor", "criticality": True, "priority": "HIGHEST", "code_metrics": {"size": {"total_loc": 2900, "total_classes": 14, "total_methods": 88}, "complexity": {"avg_wmc": 15.5}, "cohesion": {"avg_lcom": 13.0}, "coupling": {"avg_cbo": 7.5, "avg_rfc": 23.0}}},
            {"id": "A4", "name": "alarm_control_panel", "app_type": "actuator", "criticality": True, "priority": "HIGHEST", "code_metrics": {"size": {"total_loc": 3400, "total_classes": 16, "total_methods": 105}, "complexity": {"avg_wmc": 17.2}, "cohesion": {"avg_lcom": 15.8}, "coupling": {"avg_cbo": 8.9, "avg_rfc": 28.1}}},
            {"id": "A5", "name": "emergency_actuation_manager", "app_type": "actuator", "criticality": True, "priority": "HIGHEST", "code_metrics": {"size": {"total_loc": 2100, "total_classes": 11, "total_methods": 65}, "complexity": {"avg_wmc": 12.0}, "cohesion": {"avg_lcom": 10.5}, "coupling": {"avg_cbo": 6.2, "avg_rfc": 19.5}}},

            # Device Integrations
            {"id": "A6", "name": "zha_zigbee_gateway", "app_type": "sensor", "criticality": True, "priority": "HIGH", "code_metrics": {"size": {"total_loc": 4800, "total_classes": 24, "total_methods": 150}, "complexity": {"avg_wmc": 21.4}, "cohesion": {"avg_lcom": 20.2}, "coupling": {"avg_cbo": 11.0, "avg_rfc": 35.0}}},
            {"id": "A7", "name": "zwave_js_supervisor", "app_type": "sensor", "criticality": True, "priority": "HIGH", "code_metrics": {"size": {"total_loc": 4300, "total_classes": 21, "total_methods": 135}, "complexity": {"avg_wmc": 19.8}, "cohesion": {"avg_lcom": 18.5}, "coupling": {"avg_cbo": 10.2, "avg_rfc": 32.4}}},
            {"id": "A8", "name": "esphome_device_manager", "app_type": "sensor", "criticality": False, "priority": "MEDIUM", "code_metrics": {"size": {"total_loc": 3100, "total_classes": 16, "total_methods": 92}, "complexity": {"avg_wmc": 14.5}, "cohesion": {"avg_lcom": 13.0}, "coupling": {"avg_cbo": 7.4, "avg_rfc": 23.8}}},
            {"id": "A9", "name": "mqtt_event_bridge", "app_type": "processor", "criticality": True, "priority": "HIGH", "code_metrics": {"size": {"total_loc": 2600, "total_classes": 13, "total_methods": 80}, "complexity": {"avg_wmc": 13.0}, "cohesion": {"avg_lcom": 11.8}, "coupling": {"avg_cbo": 6.8, "avg_rfc": 21.5}}},
            {"id": "A10", "name": "camera_stream_manager", "app_type": "sensor", "criticality": False, "priority": "MEDIUM", "code_metrics": {"size": {"total_loc": 3500, "total_classes": 17, "total_methods": 110}, "complexity": {"avg_wmc": 16.8}, "cohesion": {"avg_lcom": 15.0}, "coupling": {"avg_cbo": 8.5, "avg_rfc": 27.0}}},
            {"id": "A11", "name": "matter_thread_bridge", "app_type": "sensor", "criticality": False, "priority": "HIGH", "code_metrics": {"size": {"total_loc": 3900, "total_classes": 19, "total_methods": 125}, "complexity": {"avg_wmc": 18.2}, "cohesion": {"avg_lcom": 16.9}, "coupling": {"avg_cbo": 9.4, "avg_rfc": 30.1}}},

            # Actuation & Environment
            {"id": "A12", "name": "climate_hvac_controller", "app_type": "actuator", "criticality": True, "priority": "HIGH", "code_metrics": {"size": {"total_loc": 2800, "total_classes": 14, "total_methods": 85}, "complexity": {"avg_wmc": 14.0}, "cohesion": {"avg_lcom": 12.5}, "coupling": {"avg_cbo": 7.1, "avg_rfc": 22.8}}},
            {"id": "A13", "name": "light_switch_controller", "app_type": "actuator", "criticality": False, "priority": "MEDIUM", "code_metrics": {"size": {"total_loc": 2200, "total_classes": 11, "total_methods": 70}, "complexity": {"avg_wmc": 11.0}, "cohesion": {"avg_lcom": 9.8}, "coupling": {"avg_cbo": 5.8, "avg_rfc": 18.2}}},
            {"id": "A14", "name": "presence_detection_engine", "app_type": "processor", "criticality": True, "priority": "HIGH", "code_metrics": {"size": {"total_loc": 2500, "total_classes": 12, "total_methods": 78}, "complexity": {"avg_wmc": 12.5}, "cohesion": {"avg_lcom": 11.2}, "coupling": {"avg_cbo": 6.5, "avg_rfc": 20.4}}},
            {"id": "A15", "name": "media_player_coordinator", "app_type": "actuator", "criticality": False, "priority": "LOW", "code_metrics": {"size": {"total_loc": 1900, "total_classes": 10, "total_methods": 60}, "complexity": {"avg_wmc": 9.5}, "cohesion": {"avg_lcom": 8.5}, "coupling": {"avg_cbo": 5.0, "avg_rfc": 15.8}}},

            # Storage, Analytics & Notifications
            {"id": "A16", "name": "recorder_persistence_worker", "app_type": "processor", "criticality": True, "priority": "HIGH", "code_metrics": {"size": {"total_loc": 4100, "total_classes": 20, "total_methods": 130}, "complexity": {"avg_wmc": 19.0}, "cohesion": {"avg_lcom": 17.5}, "coupling": {"avg_cbo": 9.8, "avg_rfc": 31.0}}},
            {"id": "A17", "name": "energy_analytics_worker", "app_type": "processor", "criticality": False, "priority": "LOW", "code_metrics": {"size": {"total_loc": 2700, "total_classes": 13, "total_methods": 82}, "complexity": {"avg_wmc": 13.5}, "cohesion": {"avg_lcom": 12.0}, "coupling": {"avg_cbo": 6.9, "avg_rfc": 22.0}}},
            {"id": "A18", "name": "logbook_history_service", "app_type": "processor", "criticality": False, "priority": "LOW", "code_metrics": {"size": {"total_loc": 1800, "total_classes": 9, "total_methods": 55}, "complexity": {"avg_wmc": 9.0}, "cohesion": {"avg_lcom": 8.0}, "coupling": {"avg_cbo": 4.8, "avg_rfc": 15.0}}},
            {"id": "A19", "name": "notification_dispatcher", "app_type": "actuator", "criticality": True, "priority": "HIGH", "code_metrics": {"size": {"total_loc": 2400, "total_classes": 12, "total_methods": 75}, "complexity": {"avg_wmc": 12.0}, "cohesion": {"avg_lcom": 10.8}, "coupling": {"avg_cbo": 6.2, "avg_rfc": 19.8}}},

            # Ingress & UI
            {"id": "A20", "name": "websocket_api_server", "app_type": "sensor", "criticality": True, "priority": "HIGH", "code_metrics": {"size": {"total_loc": 3600, "total_classes": 18, "total_methods": 115}, "complexity": {"avg_wmc": 17.0}, "cohesion": {"avg_lcom": 15.5}, "coupling": {"avg_cbo": 8.8, "avg_rfc": 28.0}}},
            {"id": "A21", "name": "http_api_ingress", "app_type": "sensor", "criticality": True, "priority": "HIGH", "code_metrics": {"size": {"total_loc": 3100, "total_classes": 15, "total_methods": 96}, "complexity": {"avg_wmc": 15.2}, "cohesion": {"avg_lcom": 13.8}, "coupling": {"avg_cbo": 7.9, "avg_rfc": 25.0}}},
            {"id": "A22", "name": "lovelace_ui_dashboard", "app_type": "actuator", "criticality": False, "priority": "MEDIUM", "code_metrics": {"size": {"total_loc": 4600, "total_classes": 23, "total_methods": 145}, "complexity": {"avg_wmc": 20.5}, "cohesion": {"avg_lcom": 19.0}, "coupling": {"avg_cbo": 10.5, "avg_rfc": 33.5}}},
            {"id": "A23", "name": "cloud_remote_agent", "app_type": "sensor", "criticality": False, "priority": "MEDIUM", "code_metrics": {"size": {"total_loc": 2300, "total_classes": 11, "total_methods": 72}, "complexity": {"avg_wmc": 11.5}, "cohesion": {"avg_lcom": 10.2}, "coupling": {"avg_cbo": 5.9, "avg_rfc": 18.6}}}
        ]
    ...
    def create_edgex_foundry_topology() -> Dict[str, Any]:
        ...
        topics = [
            ...
            {"id": "T3", "name": "edgex.events.device.vision_anomaly", "size": 4096, "qos": {"durability": "TRANSIENT_LOCAL", "reliability": "RELIABLE", "transport_priority": "CRITICAL"}, "frequency": 10.0, "criticality": "critical"},
            ...
            {"id": "T6", "name": "edgex.commands.request.actuate_valve", "size": 256, "qos": {"durability": "PERSISTENT", "reliability": "RELIABLE", "transport_priority": "CRITICAL"}, "frequency": 5.0, "criticality": "critical"},
            {"id": "T7", "name": "edgex.commands.request.emergency_stop", "size": 128, "qos": {"durability": "TRANSIENT_LOCAL", "reliability": "RELIABLE", "transport_priority": "HIGHEST"}, "frequency": 1.0, "criticality": "critical"},
            ...
            {"id": "T10", "name": "edgex.alerts.critical_safety", "size": 512, "qos": {"durability": "TRANSIENT_LOCAL", "reliability": "RELIABLE", "transport_priority": "HIGHEST"}, "frequency": 2.0, "criticality": "critical"},
            {"id": "T11", "name": "edgex.alerts.equipment_fault", "size": 512, "qos": {"durability": "TRANSIENT_LOCAL", "reliability": "RELIABLE", "transport_priority": "CRITICAL"}, "frequency": 5.0, "criticality": "critical"},
            ...
            {"id": "T18", "name": "edgex.notifications.sms_pager", "size": 256, "qos": {"durability": "TRANSIENT_LOCAL", "reliability": "RELIABLE", "transport_priority": "HIGHEST"}, "frequency": 1.0, "criticality": "critical"},
        ...
        applications = [
            ...
            {"id": "A0", "name": "device_modbus_service", "app_type": "sensor", "criticality": True, "priority": "HIGH", "code_metrics": {"size": {"total_loc": 4200, "total_classes": 22, "total_methods": 135}, "complexity": {"avg_wmc": 19.5}, "cohesion": {"avg_lcom": 18.0}, "coupling": {"avg_cbo": 9.5, "avg_rfc": 31.0}}},
            {"id": "A1", "name": "device_mqtt_service", "app_type": "sensor", "criticality": True, "priority": "HIGH", "code_metrics": {"size": {"total_loc": 3600, "total_classes": 18, "total_methods": 115}, "complexity": {"avg_wmc": 16.8}, "cohesion": {"avg_lcom": 15.5}, "coupling": {"avg_cbo": 8.5, "avg_rfc": 27.5}}},
            {"id": "A2", "name": "device_gpio_service", "app_type": "sensor", "criticality": True, "priority": "HIGHEST", "code_metrics": {"size": {"total_loc": 2800, "total_classes": 14, "total_methods": 88}, "complexity": {"avg_wmc": 14.0}, "cohesion": {"avg_lcom": 12.5}, "coupling": {"avg_cbo": 7.0, "avg_rfc": 22.0}}},
            {"id": "A3", "name": "device_camera_vision_service", "app_type": "sensor", "criticality": True, "priority": "HIGH", "code_metrics": {"size": {"total_loc": 5200, "total_classes": 26, "total_methods": 160}, "complexity": {"avg_wmc": 23.5}, "cohesion": {"avg_lcom": 22.0}, "coupling": {"avg_cbo": 11.5, "avg_rfc": 37.0}}},
            {"id": "A4", "name": "device_snmp_service", "app_type": "sensor", "criticality": False, "priority": "LOW", "code_metrics": {"size": {"total_loc": 2100, "total_classes": 11, "total_methods": 65}, "complexity": {"avg_wmc": 10.5}, "cohesion": {"avg_lcom": 9.5}, "coupling": {"avg_cbo": 5.2, "avg_rfc": 16.5}}},

            # Core Services Layer
            {"id": "A5", "name": "core_data_service", "app_type": "processor", "criticality": True, "priority": "HIGHEST", "code_metrics": {"size": {"total_loc": 6100, "total_classes": 29, "total_methods": 185}, "complexity": {"avg_wmc": 26.0}, "cohesion": {"avg_lcom": 24.5}, "coupling": {"avg_cbo": 13.0, "avg_rfc": 42.0}}},
            {"id": "A6", "name": "core_metadata_service", "app_type": "processor", "criticality": True, "priority": "HIGH", "code_metrics": {"size": {"total_loc": 5400, "total_classes": 25, "total_methods": 165}, "complexity": {"avg_wmc": 22.5}, "cohesion": {"avg_lcom": 21.0}, "coupling": {"avg_cbo": 11.2, "avg_rfc": 36.0}}},
            {"id": "A7", "name": "core_command_service", "app_type": "actuator", "criticality": True, "priority": "HIGHEST", "code_metrics": {"size": {"total_loc": 4800, "total_classes": 23, "total_methods": 145}, "complexity": {"avg_wmc": 20.0}, "cohesion": {"avg_lcom": 18.8}, "coupling": {"avg_cbo": 10.0, "avg_rfc": 32.5}}},
            {"id": "A8", "name": "core_keeper_registry", "app_type": "processor", "criticality": True, "priority": "HIGH", "code_metrics": {"size": {"total_loc": 3900, "total_classes": 19, "total_methods": 120}, "complexity": {"avg_wmc": 17.5}, "cohesion": {"avg_lcom": 16.0}, "coupling": {"avg_cbo": 8.8, "avg_rfc": 28.5}}},

            # Northbound App & Analytics Services
            {"id": "A9", "name": "app_service_configurable", "app_type": "processor", "criticality": True, "priority": "HIGH", "code_metrics": {"size": {"total_loc": 5900, "total_classes": 28, "total_methods": 175}, "complexity": {"avg_wmc": 25.0}, "cohesion": {"avg_lcom": 23.5}, "coupling": {"avg_cbo": 12.5, "avg_rfc": 40.5}}},
            {"id": "A10", "name": "app_rules_engine_ekuiper", "app_type": "processor", "criticality": True, "priority": "HIGHEST", "code_metrics": {"size": {"total_loc": 7200, "total_classes": 34, "total_methods": 215}, "complexity": {"avg_wmc": 31.0}, "cohesion": {"avg_lcom": 29.5}, "coupling": {"avg_cbo": 15.0, "avg_rfc": 49.0}}},
            {"id": "A11", "name": "app_safety_interlock", "app_type": "actuator", "criticality": True, "priority": "HIGHEST", "code_metrics": {"size": {"total_loc": 3100, "total_classes": 15, "total_methods": 95}, "complexity": {"avg_wmc": 15.5}, "cohesion": {"avg_lcom": 13.8}, "coupling": {"avg_cbo": 7.8, "avg_rfc": 24.5}}},
            {"id": "A12", "name": "app_cloud_exporter_aws", "app_type": "processor", "criticality": False, "priority": "MEDIUM", "code_metrics": {"size": {"total_loc": 3300, "total_classes": 16, "total_methods": 100}, "complexity": {"avg_wmc": 15.0}, "cohesion": {"avg_lcom": 13.5}, "coupling": {"avg_cbo": 7.5, "avg_rfc": 24.0}}},
            {"id": "A13", "name": "app_cloud_exporter_azure", "app_type": "processor", "criticality": False, "priority": "MEDIUM", "code_metrics": {"size": {"total_loc": 3200, "total_classes": 15, "total_methods": 98}, "complexity": {"avg_wmc": 14.8}, "cohesion": {"avg_lcom": 13.2}, "coupling": {"avg_cbo": 7.2, "avg_rfc": 23.5}}},
            {"id": "A14", "name": "app_historian_persister", "app_type": "processor", "criticality": True, "priority": "HIGH", "code_metrics": {"size": {"total_loc": 3500, "total_classes": 17, "total_methods": 108}, "complexity": {"avg_wmc": 16.2}, "cohesion": {"avg_lcom": 14.8}, "coupling": {"avg_cbo": 8.0, "avg_rfc": 26.0}}},

            # Support & Security Services
            {"id": "A15", "name": "support_notifications", "app_type": "actuator", "criticality": True, "priority": "HIGHEST", "code_metrics": {"size": {"total_loc": 3700, "total_classes": 18, "total_methods": 112}, "complexity": {"avg_wmc": 17.0}, "cohesion": {"avg_lcom": 15.2}, "coupling": {"avg_cbo": 8.4, "avg_rfc": 27.2}}},
            {"id": "A16", "name": "support_scheduler", "app_type": "sensor", "criticality": False, "priority": "MEDIUM", "code_metrics": {"size": {"total_loc": 2400, "total_classes": 12, "total_methods": 76}, "complexity": {"avg_wmc": 12.2}, "cohesion": {"avg_lcom": 11.0}, "coupling": {"avg_cbo": 6.1, "avg_rfc": 19.5}}},
            {"id": "A17", "name": "security_proxy_kong", "app_type": "sensor", "criticality": True, "priority": "HIGH", "code_metrics": {"size": {"total_loc": 4400, "total_classes": 21, "total_methods": 132}, "complexity": {"avg_wmc": 19.2}, "cohesion": {"avg_lcom": 17.8}, "coupling": {"avg_cbo": 9.8, "avg_rfc": 31.5}}},
            {"id": "A18", "name": "security_secretstore_vault", "app_type": "processor", "criticality": True, "priority": "HIGHEST", "code_metrics": {"size": {"total_loc": 4100, "total_classes": 20, "total_methods": 125}, "complexity": {"avg_wmc": 18.5}, "cohesion": {"avg_lcom": 16.8}, "coupling": {"avg_cbo": 9.2, "avg_rfc": 29.8}}},
            {"id": "A19", "name": "security_bootstrapper", "app_type": "processor", "criticality": True, "priority": "HIGH", "code_metrics": {"size": {"total_loc": 2600, "total_classes": 13, "total_methods": 82}, "complexity": {"avg_wmc": 13.0}, "cohesion": {"avg_lcom": 11.5}, "coupling": {"avg_cbo": 6.6, "avg_rfc": 21.0}}},
            {"id": "A20", "name": "system_management_agent", "app_type": "sensor", "criticality": False, "priority": "LOW", "code_metrics": {"size": {"total_loc": 2200, "total_classes": 11, "total_methods": 68}, "complexity": {"avg_wmc": 11.0}, "cohesion": {"avg_lcom": 9.8}, "coupling": {"avg_cbo": 5.5, "avg_rfc": 17.5}}},
            {"id": "A21", "name": "ui_management_dashboard", "app_type": "actuator", "criticality": False, "priority": "LOW", "code_metrics": {"size": {"total_loc": 3800, "total_classes": 19, "total_methods": 118}, "complexity": {"avg_wmc": 17.5}, "cohesion": {"avg_lcom": 16.0}, "coupling": {"avg_cbo": 8.7, "avg_rfc": 28.0}}}
        ]
