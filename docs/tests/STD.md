...
|---------|-------|-------------|---------------|
| ST-E2E-01 | Small | Full CLI pipeline (~10–25 components) | All 8 methodology steps complete (Import → Analyze → Predict → Diagnose → Simulate → Validate → Prescribe → Visualize); dashboard generated. Generate (Stage 0) is pre-pipeline and excluded from this count. |
| ST-E2E-02 | Medium | Full CLI pipeline (~30–50 components) | All 8 methodology steps complete; validation passes |
| ST-E2E-03 | Large | Full CLI pipeline (~60–100 components) | All 8 methodology steps complete within time budget |
...
| REQ-QS-04 | RETIRED — Vulnerability/Security dimension deleted, see [structural-analysis.md §11](../structural-analysis.md#11-end-to-end-step-by-step-worked-example) | — |
