...
The manuscript runs to **25 single-column pages** in the `elsarticle` preprint class, including all
...
- **Supplementary Material (S1–S32, 27 pages):** sensitivity sweeps, AHP matrices, corpus parameters
  ...
  QoS-attribution controls, and the HGT message-passing equations.
