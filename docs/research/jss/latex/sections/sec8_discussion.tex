...
S_{\text{diverge}} &= \big\{ v \in V_{\text{app}} \;\big|\; |\text{rank}_{\text{HGT-QoS}}(v) - \text{rank}_{\text{Topo-QoS}}(v)| \ge \Delta_{\text{thresh}} \land (v \in \text{Top}_K(\text{HGT}) \lor v \in \text{Top}_K(\text{Topo})) \big\}
\end{align}
