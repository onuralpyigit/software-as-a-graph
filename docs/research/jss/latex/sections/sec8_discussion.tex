...
\textbf{Learned + QoS inputs} & Substantially different or irregular architectures & Best transfer (\texttt{GAT-QoS} $0.805$, \texttt{HGT-QoS} $0.760$) and identification (PR-AUC $0.71$--$0.79$). \\
