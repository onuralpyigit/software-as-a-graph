...
\midrule
In-distribution ranking & Eleven evaluation scenarios $+$ ATM & 12 & Table~\ref{tab:5}, Supp.~S10 \\
...
Cross-oracle convergent validity & Same twelve LOSO folds & 12 & Section~\ref{sec:7.3.convergent}, Supp.~S9 \\
