...
\midrule
\multicolumn{7}{l}{\textit{Attribution controls (Section~\ref{sec:rq2}): the same node features without a graph model, and without QoS node columns}} \\
