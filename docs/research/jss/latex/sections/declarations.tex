...
\noindent\textbf{Declaration of Generative AI.} The authors used Anthropic’s Claude for typesetting and readability, taking full responsibility for all content. No generative AI was used to design the study, analyze data, or generate results; figures and tables render deterministically.
