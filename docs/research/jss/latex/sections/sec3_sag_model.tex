...
% TODO(revision): re-run the topic-weight and AHP-shrinkage sensitivity sweeps
% (Section~\ref{sec:7.3.topicw}, Table~8b, Figure~4) against the corrected
% SizeNorm envelope and the re-elicited QoS sub-weights before citing updated
% rank-correlation figures in this paragraph.
