...
The multi-metric failure simulator can blend declared topic criticality into its severity term; this is disabled because topic criticality is a GNN input feature and consuming it would score the predictor against a transformation of its own input.
