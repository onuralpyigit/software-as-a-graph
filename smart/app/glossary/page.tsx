...
const ABBREVIATIONS: Abbreviation[] = [
  ...
  { abbr: "GNN",  expansion: "Graph Neural Network",                  definition: "The machine-learning model in Step 3 (Predict). A heterogeneous GAT trained on simulate-derived ground-truth labels that generalises beyond closed-form RM scoring." },
